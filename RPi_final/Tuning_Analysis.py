    ...
    for dut in active_duts:
        ...
        if is_pass:
            ...
            if linearity_is_sig:
                ...
                linearity_direction = 'upward "smiling"' if midpoint_error_from_line > 0 else 'downward "frowning"'
                suggestion_parts.append(f"4. Linearity Adjustment: Correct the {linearity_direction} bow at 50% FS.")
